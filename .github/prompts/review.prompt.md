...
- For Terraform files: classify any state exposure of credentials or tokens as a high-severity security finding.
- Block if plaintext credential material is introduced into Terraform state, even if detect-secrets passes.
